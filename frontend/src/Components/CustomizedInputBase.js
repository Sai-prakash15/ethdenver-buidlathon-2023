...
export function CustomizedInputBase(props) {
  ...
  const subgraphs = [{"id": "uniswap-v3", "subgraph": "uniswap-v3"},{"id": "opensea-v2", "subgraph": "opensea-v2"},{"id": "aave-governance", "subgraph": "aave-governance"},{"id": "sporkdao-token", "subgraph": "sporkdao-token"},{"id": "uniswap-governance", "subgraph": "uniswap-governance"}];
